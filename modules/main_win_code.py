...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.own_box = QtWidgets.QCheckBox(self.gridLayoutWidget_3)
        self.own_box.setEnabled(True)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.own_box.setFont(font)
        self.own_box.setChecked(False)
        self.own_box.setObjectName("own_box")
        self.comboBoxLay.addWidget(self.own_box, 0, 0, 1, 1)
        self.selected_props = QtWidgets.QComboBox(self.gridLayoutWidget_3)
        self.selected_props.setObjectName("selected_props")
        self.comboBoxLay.addWidget(self.selected_props, 1, 0, 1, 1)
...
"0.201 кгС\n"
"200 гС"))
        self.own_box.setText(_translate("MainWindow", "Подобрать наиболее похожий"))
