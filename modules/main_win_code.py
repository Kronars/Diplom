...
# Form implementation generated from reading ui file 'C:\Users\Senya\Prog_2\Diplom_rework\main_win.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.title = QtWidgets.QLabel(self.general_lay)
        self.title.setGeometry(QtCore.QRect(340, 10, 148, 26))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(11, 44, 301, 341))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(11, 463, 281, 351))
        ...
        self.mean_speed_val = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.mean_speed_val.setFont(font)
        self.mean_speed_val.setObjectName("mean_speed_val")
        self.stats_lay.addWidget(self.mean_speed_val, 4, 1, 1, 1)
        ...
        self.max_speed_val = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setKerning(True)
        self.max_speed_val.setFont(font)
        self.max_speed_val.setObjectName("max_speed_val")
        self.stats_lay.addWidget(self.max_speed_val, 3, 1, 1, 1)
        ...
        self.mean_speed_text = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.mean_speed_text.setFont(font)
        self.mean_speed_text.setObjectName("mean_speed_text")
        self.stats_lay.addWidget(self.mean_speed_text, 4, 0, 1, 1)
        ...
        self.max_speed_text = QtWidgets.QLabel(self.layoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.max_speed_text.setFont(font)
        self.max_speed_text.setObjectName("max_speed_text")
        self.stats_lay.addWidget(self.max_speed_text, 3, 0, 1, 1)
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(11, 390, 1191, 63))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(340, 40, 861, 341))
        ...
        self.front_prop.setPixmap(QtGui.QPixmap("C:\\Users\\Senya\\Prog_2\\Diplom_rework\\../../../Лена/.designer/backup/resize.png"))
        ...
        self.side_prop.setPixmap(QtGui.QPixmap("C:\\Users\\Senya\\Prog_2\\Diplom_rework\\../../../Лена/.designer/backup/resize.png"))
        ...
        self.graphWidget.setGeometry(QtCore.QRect(310, 465, 891, 295))
        self.graphWidget.setObjectName("graphWidget")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.general_lay)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(310, 770, 891, 41))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.formulas_lay = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.formulas_lay.setContentsMargins(0, 0, 0, 0)
        self.formulas_lay.setObjectName("formulas_lay")
        ...
        self.formulas_lay.addWidget(self.thr_formula)
        ...
        self.formulas_lay.addWidget(self.pow_formula)
        MainWindow.setCentralWidget(self.general_lay)

        self.retranslateUi(MainWindow)
        self.rpm_num.valueChanged['int'].connect(self.rpm_slider.setValue) # type: ignore
        self.rpm_slider.valueChanged['int'].connect(self.rpm_num.setValue) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Prop Selector"))
        self.title.setText(_translate("MainWindow", "Подбор винта"))
        ...
        self.mean_speed_val.setText(_translate("MainWindow", "15 км/ч"))
        self.curr_prop_text.setText(_translate("MainWindow", "Текущий винт:"))
        self.max_speed_val.setText(_translate("MainWindow", "30 км/ч"))
...
"0.201 кгС\n"
"200 гС"))
        self.mean_speed_text.setText(_translate("MainWindow", "Средняя скорость:"))
        self.pwr_vals.setText(_translate("MainWindow", "0.5 Н\n"
"0.201 кгС\n"
"200 гС"))
        self.max_speed_text.setText(_translate("MainWindow", "Максимальная скорость:"))
